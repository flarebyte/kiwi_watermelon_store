...
void main() {
  ...
  group('KiwiWatermelonTokenStreamFlyweight.consumeIdentifier', () {
    test('consumes identifier when token matches', () {
      ...
      final result =
          KiwiWatermelonTokenStreamFlyweight.consumeIdentifier(toStream('INCR env:flag'));
    ...
    test('throws SemanticException when token is not identifier', () {
      expect(() => KiwiWatermelonTokenStreamFlyweight.consumeIdentifier(toStream('12 INCR env:flag')),
  ...
  group('Semicolon Methods', () {
    test('peekIsSemicolon returns true for semicolon', () {
      ...
      expect(KiwiWatermelonTokenStreamFlyweight.peekIsSemicolon(toStream('INCR ;')), isTrue);
    });

    test('peekIsSemicolon returns false for non-semicolon', () {
     
      expect(KiwiWatermelonTokenStreamFlyweight.peekIsSemicolon(toStream('INCR ,')), isFalse);
    });
    ...
    test('consumeSemicolon throws if not semicolon', () {
      expect(() => KiwiWatermelonTokenStreamFlyweight.consumeSemicolon(toStream('12 INCR env:flag')),
          throwsA(isA<KiwiWatermelonSemanticException>()));
    });
  });
  ...
  group('Colon Methods', () {
    ...
    test('peekIsColon returns true for colon', () {
      expect(KiwiWatermelonTokenStreamFlyweight.peekIsColon(toStream('env:other')), isTrue);
    });

    test('peekIsColon returns false for non-colon', () {
      
      expect(KiwiWatermelonTokenStreamFlyweight.peekIsColon(toStream('12 INCR env:flag')), isFalse);
    });
    ...
    test('consumeColon throws if not colon', () {
      expect(() => KiwiWatermelonTokenStreamFlyweight.consumeColon(toStream('12 INCR env:flag')),
          throwsA(isA<KiwiWatermelonSemanticException>()));
    });
  });
  ...
  group('KiwiWatermelonTokenStreamFlyweight.isSemicolon', () {
    ...
    test('returns true when current token is semicolon', () {
      ...
      final result = KiwiWatermelonTokenStreamFlyweight.isSemicolon(toStream(';'));
      expect(result, isTrue);
    });

    test('returns false when current token is not semicolon', () {

      final result = KiwiWatermelonTokenStreamFlyweight.isSemicolon(toStream('other'));
  ...
  group('KiwiWatermelonTokenStreamFlyweight.isColon', () {
    ...
    test('returns false when current token is not colon', () {
      final result = KiwiWatermelonTokenStreamFlyweight.isColon(toStream('other'));
      expect(result, isFalse);
    });
  });
